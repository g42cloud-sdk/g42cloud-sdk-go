...
func TestEnvProvider_GetRegion2(t *testing.T) {
	...
	err := os.Setenv("G42CLOUD_SDK_REGION_SERVICE1_REGION_ID_1", "https://service1.region-id-1.com")
	assert.Nil(t, err)
...
func TestEnvProvider_GetRegion3(t *testing.T) {
	...
	err := os.Setenv("G42CLOUD_SDK_REGION_SERVICE2_REGION_ID_2", "https://service2.region-id-2.com,https://service2.region-id-2.cn")
	assert.Nil(t, err)
